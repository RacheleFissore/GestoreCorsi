...
public class Corso {
	...
	// Sono le colonne della tabella corso all'interno del db iscritticorso
	...
	// Generate hashCode() and equals() viene generato SOLO sul campo chiave primaria perchè tanto non possono esserci due elementi con la stessa 
	// chiave primaria
